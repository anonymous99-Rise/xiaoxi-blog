...
date: "2026-03-18T20:04:00"
preview_en: "From 2.2s to 1.1s — how to make your AI assistant respond 2x faster"
preview_zh: "从 2.2 秒到 1.1 秒 — 如何让 AI 助手响应速度翻倍"
---
...
**核心策略**:
1. **模型分层**: 不同任务用不同模型
2. **Prompt 缓存**: 避免重复加载上下文
3. **Heartbeat 优化**: 用最便宜的模型
4. **Budget Controls**: 设置每日/每周 token 上限
